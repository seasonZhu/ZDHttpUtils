#
#  Be sure to run `pod spec lint ZDHttpUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ZDHttpUtils"
  s.version      = "0.0.1"
  s.summary      = "Swift 基于Alamofire/ObjectMapper/SwiftyJson的封装."
  ...
  s.source       = { :git => "https://github.com/seasonZhu/ZDHttpUtils.git", :tag => "#{s.version}" }
